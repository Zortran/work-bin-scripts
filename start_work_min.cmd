...
set programs_list= "C:\Program Files\Telegram Desktop\Telegram.exe" "C:\Program Files\KeePass Password Safe 2\KeePass.exe" "C:\Program Files (x86)\Caramba\Switcher\CarambaSwitcher.exe" "C:\Program Files (x86)\Cisco\Cisco Secure Client\UI\csc_ui.exe" "C:\Program Files\Buzz\Buzz.exe" "C:\Users\zortr\AppData\Local\Programs\Buzz\Buzz.exe" "%USERPROFILE%\AppData\Local\Programs\ktalk\ktalk.exe"
